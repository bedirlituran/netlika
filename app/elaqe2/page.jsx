  ...
  return (
    <section className="bg-white dark:bg-gray-900 p-4 md:p-8 lg:p-12">
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col gap-6 justify-center items-center text-center md:flex-row md:gap-6 md:justify-around">
          <div>
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">077 223 44 71<br />077 223 44 35 <br/>
            077 466 05 05</p>
          </div>
