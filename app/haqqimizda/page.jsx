  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center py-10">
      <div className="max-w-2xl p-8 bg-white shadow-md rounded-md py-10">
        ...
        <p className="text-lg mb-6">
          <strong>İlə Əlaqə:</strong> Bizimlə əlaqə saxlamaq və bizdən ən son xəbərləri almaq üçün sosial media platformalarımızı izləyin. Kampaniyalarımızdan və müştərilərimizə təqdim etdiyimiz maraqlı təkliflərdən xəbərdar olun.
        </p>
        <p className="text-lg mb-6">
