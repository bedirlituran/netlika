...
const Googleplay = () => {
  return (
    <section className="rounded-2xl py-6 mt-20 bg-gray-100 text-black">
	<div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
		<div className="flex flex-col justify-center lg:text-left">
			<h1 className="py-2 text-3xl font-medium leadi title-font bg-black text-white p-8 rounded-2xl">GammaNet tədbiqini yüklə</h1>
		</div>
		<div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
			<Link href='https://play.google.com/store/apps/details?id=ru.tvip.tv' target='blank' className="inline-flex items-center px-6 py-3 rounded-lg bg-black text-white">
			...
			<Link href='https://play.google.com/store/apps/details?id=ru.tvip.tv' target='blank' className="inline-flex items-center px-5 py-3 rounded-lg bg-black text-white">
