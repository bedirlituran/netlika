...
<div className="flex-wrap items-center justify-center gap-8 font-custom text-center sm:flex">
    <div className="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
        ...
        <Link href='/Reqemsal' className=" text-gray-500 text-md dark:text-gray-300">
            Rəqəmsal Tv
        </Link>
        <Link href='/ChannelList' className=" text-gray-500 text-md dark:text-gray-300">
            Kanal Siyahısı
        </Link>
        </div>
    ...
    <div className="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 sm:mt-16 md:mt-20 lg:mt-24 dark:bg-gray-800">
        ...
        <div className='flex flex-col gap-2 mb-4' >
        <Link href='/' className=" text-gray-500 text-md dark:text-gray-300">
            Tariflər
        </Link>
        <Link href='/' className=" text-gray-500 text-md dark:text-gray-300">
            Kampaniyalar
    ...
    <div className="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
        ...
        <div className='flex flex-col gap-2 mb-4' >
        <Link href='/Iptv' className=" text-gray-500 text-md dark:text-gray-300">
            Gammanet Ip Tv
        </Link>
        <a href='https://play.google.com/store/apps/details?id=ru.tvip.atv' className=" text-gray-500 text-md dark:text-gray-300">
            Ip Tv Yüklə
        </a>
        </div>
        <Link href="/Muraciet" className="m-auto mt-10 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-2xl hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 font-turan uppercase">
