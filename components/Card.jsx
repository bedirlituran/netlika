...
const Card = ({ icon, stat, orta, asagi, link }) => {
  ...
  return (
    <div className="font-custom mt-0 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0 cursor-pointer md:flex md:flex-nowrap rounded-2xl flex flex-col justify-center items-center">
      <div className="h-full w-full md:w-full md:flex flex justify-center items-center placeholder:first:group rounded-2xl bg-gray-200 py-auto text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16 hover:bg-red-200 hover:text-slate-100 transition-all duration-500 shadow-xl">
        <div className="flex flex-col gap-3 mx-auto max-w-xs px-8 w-[260px]">
          ...
          <div className="mt-6 flex items-baseline justify-center gap-x-2">
            <Link href={links[orta]} className="m-auto rounded-md px-3 py-2 text-lg font-semibold text-black shadow-2xl hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 font-turan">
              {ortas[orta]}
            </Link>
          </div>
          <div className="flex items-baseline justify-center gap-x-2">
            <Link href={links[asagi]} className="m-auto rounded-md px-3 py-2 text-lg font-semibold text-black shadow-2xl hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 font-turan">
              {asagilar[asagi]}
            </Link>
          </div>
