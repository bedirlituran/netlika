...
export const Pricing = () => {
    return (
      <div className="px-4 py-16 mx-auto font-bold bg-gray-50 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <div className="grid max-w-md gap-10 row-gap-5 lg:max-w-screen-lg sm:row-gap-10 lg:grid-cols-3 xl:max-w-screen-lg sm:mx-auto">
          <div className="flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow">
            <div className="text-center">
              ...
              <div className="flex items-center justify-center mt-2">
                <div className="mr-1 text-4xl font-bold">Tv</div>
              </div>
          ...
          <div className="relative flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow border-deep-purple-accent-400">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center mt-2">
                <div className="mr-1 text-4xl font-bold">Tv & İnternet</div>
